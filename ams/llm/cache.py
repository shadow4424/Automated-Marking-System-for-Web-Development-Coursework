...
class RequestCache:
    """SQLite-based cache for LLM requests. Hashes prompts and stores responses to avoid duplicate calls."""

    def __init__(self, db_path: str | Path | None = None):
        """Initialise the cache. Args: db_path: Path to SQLite database. Defaults to ams/cache.db"""
        if db_path is None:
