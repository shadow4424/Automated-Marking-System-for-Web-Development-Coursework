...
Provides utilities for creating and cleaning up run directories.
"""
...
class WorkspaceManager:
    """Manages run workspaces: creation, cleanup, and organization.
    
    Attributes:
        root: Base directory for all runs.
    """
    ...
    def create_run_directory(
        ...
        Args:
            prefix: Prefix for the run directory (e.g., 'mark', 'batch').
            assignment_id: Optional assignment ID for organization.
    ...
    def cleanup_old_runs(
        ...
        Args:
            max_age_hours: Maximum age in hours. Defaults to WORKSPACE_MAX_AGE_HOURS.
    ...
    def get_disk_usage(self) -> dict:
        ...
        Returns:
            Dict with total_size_mb, run_count, and oldest_run info.
        """
        total_size = 0
        run_count = 0
        oldest_mtime = None
